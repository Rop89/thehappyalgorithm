  ...
  <div class="form">
    <form class=" form flex justify-center">
      <div class="form-container pt-24 flex flex-col justify-center ">
        ...
        <input
          class="name rounded p-1 shadow resize-none"
          name="name"
          type="text"
          v-model="name"
        />
        ...
        <input
          class="email rounded p-1 shadow resize-none"
          name="email"
          type="email"
          v-model="email"
        />
        ...
        <textarea
          class="message w-64 resize-none rounded mb-8 shadow"
          name="message"
          type="text"
          v-model="message"
        ></textarea>
        <button
          class="bg-black text-white w-48 ml-8 p-2 rounded"
    ...
    <div class="social-media-contact">
      <h1 class="flex justify-center pt-16 text-lg">
        Or message us on one of our Social Media channels
      </h1>
